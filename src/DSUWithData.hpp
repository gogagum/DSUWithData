...
namespace gdsu {
    ...
    public:
        ...
        Component& joinByKeys(const KeyT& key1, const KeyT& key);
    ...
    private:
        ...
        // Map with components
        std::unordered_map<std::size_t, Component> _rootIdxToComponent;
